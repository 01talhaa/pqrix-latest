        ...
        <div className="wrap">
          ...
          <div className="content">
            <span className="char state-1">
              ...
              <span data-label="l" style={{'--i': 3} as React.CSSProperties}>l</span>
            ...
            <div className="icon">
              <Users className="w-4 h-4 text-white" style={{ zIndex: 20, position: 'relative' }} />
            </div>
...
const StyledWrapper = styled.div`
  ...
  .bg::before {
    ...
    box-shadow:
      -7px 6px 0 0 rgb(43 0 113 / 10%),
      -14px 12px 0 0 rgb(43 0 113 / 8%),
      -21px 18px 4px 0 rgb(43 0 113 / 6%);
  }
  ...
  .wrap {
    ...
    background: linear-gradient(
      to bottom,
      rgba(94, 20, 228, 0.3) 0%,
      rgba(43, 0, 113, 0.3) 100%
    );
    border: 2px solid rgba(94, 20, 228, 0.3);
    position: relative;
    transition: all 0.3s ease;
  }
...
export default AnimatedExpertButton;
