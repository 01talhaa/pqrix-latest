...
const TestimonialCard = ({
  ...
  return (
    <div className="relative w-full max-w-xs overflow-hidden rounded-3xl border border-border/30 bg-card/90 backdrop-blur-sm p-10 shadow-xl">
      <div className="absolute -top-5 -left-5 -z-10 h-40 w-40 rounded-full bg-gradient-to-b from-[#e78a53]/20 to-transparent blur-md"></div>
    ...
    <section id="testimonials" className="mb-24">
      <div className="mx-auto max-w-7xl">
        ...
        <div className="-mt-8 flex justify-center">
          <button className="group relative inline-flex items-center gap-2 rounded-full border border-[#e78a53]/30 bg-primary/10 backdrop-blur-sm px-6 py-3 text-sm font-medium text-foreground transition-all hover:border-[#e78a53]/60 hover:bg-[#e78a53]/20 active:scale-95">
