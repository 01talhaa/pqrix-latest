        ...
        <div className="wrap">
          ...
          <div className="content">
            <span className="char state-1">
              ...
              <span data-label=" " style={{'--i': 6} as React.CSSProperties}>r</span>
              <span data-label="Y" style={{'--i': 7} as React.CSSProperties}>Y</span>
              ...
              <span data-label=" " style={{'--i': 11} as React.CSSProperties}>r</span>
              <span data-label="J" style={{'--i': 12} as React.CSSProperties}>J</span>
              ...
              <span data-label="n" style={{'--i': 16} as React.CSSProperties}>n</span>
              <span data-label="e" style={{'--i': 17} as React.CSSProperties}>e</span>
              <span data-label="y" style={{'--i': 18} as React.CSSProperties}>y</span>
            </span>
            <div className="icon">
              <Rocket className="w-5 h-5 text-white" style={{ zIndex: 20, position: 'relative' }} />
            </div>
...
const StyledWrapper = styled.div`
  ...
  .bg::before {
    ...
    box-shadow:
  -4px 4px 0 0 rgb(43 0 113 / 25%),
  -8px 8px 0 0 rgb(43 0 113 / 18%),
  -12px 12px 4px 0 rgb(43 0 113 / 12%),
  -18px 18px 8px 0 rgb(43 0 113 / 8%);
  ...
  .content {
    ...
    box-shadow:
      inset -2px 12px 11px -5px #7C3AED,
  ...
  .content::before {
    ...
    opacity: 0.7;
    margin: auto;
    background: linear-gradient(to bottom, transparent, #2b0071);
  ...
  .button:active .bg::before {
    ...
    opacity: 0.7;
    box-shadow:
      -7px 6px 0 0 rgb(43 0 113 / 40%),
      -14px 12px 0 0 rgb(43 0 113 / 25%),
      -21px 18px 4px 0 rgb(43 0 113 / 15%);
  }
  .button:active .content {
    box-shadow:
      inset -1px 12px 8px -5px rgba(43, 0, 113, 0.4),
      inset 0px -3px 8px 0px #7C3AED;
  }
...
export default AnimatedJourneyButton;
