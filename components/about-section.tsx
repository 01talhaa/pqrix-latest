...
export function AboutSection() {
  ...
  return (
    <section className="py-20 px-6 sm:px-10 bg-gradient-to-b from-[#FBFFFF] to-white overflow-hidden relative">
            ...
            <div className="relative group">
              ...
              <div className="relative rounded-3xl overflow-hidden bg-gradient-to-br from-[#2b0071] to-[#5E14E4] p-1">
                <div className="relative aspect-[4/5] rounded-3xl overflow-hidden bg-gradient-to-br from-[#2b0071]/90 to-[#5E14E4]/90">
                  ...
                  <div className="absolute bottom-8 left-8 bg-white rounded-2xl px-4 py-3 shadow-2xl">
              ...
              <div className="absolute -bottom-6 -left-6 w-24 h-24 bg-gradient-to-br from-[#2b0071] to-[#5E14E4] rounded-full opacity-20 blur-xl" />
            </div>
          </div>
