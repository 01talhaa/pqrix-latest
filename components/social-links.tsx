          ...
          {links.map((link) => (
            <div key={link.name} className="relative">
              <a
                ...
                className={`w-14 h-14 bg-gradient-to-br ${link.gradient} rounded-xl flex items-center justify-center shadow-lg border ${link.border} cursor-pointer transform transition-all duration-300 ease-out hover:scale-110 hover:-translate-y-2 hover:shadow-2xl`}
              >
                {link.icon}
              </a>
            </div>
