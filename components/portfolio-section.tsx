...
export function PortfolioSection() {
  ...
  return (
    <>
      ...
      {/* Portfolio Grid */}
      <div className="grid grid-cols-1 lg:grid-cols-[280px_1fr] xl:grid-cols-[280px_1fr_400px] gap-4 md:gap-6">
        ...
        <div className={`space-y-4 ${mobileView !== "folders" ? "hidden lg:block" : "block"}`}>
          ...
          <div className="bg-card/60 backdrop-blur-sm rounded-2xl p-4 border border-border/50 space-y-1 max-h-[600px] overflow-y-auto">
            <button
        ...
        {/* Center - File List */}
        <div className={`bg-card/60 backdrop-blur-sm rounded-2xl p-4 border border-border/50 ${mobileView !== "files" ? "hidden lg:block" : "block"}`}>
          {/* Mobile Back Button */}
          <button
        ...
        <div className={`space-y-4 ${mobileView !== "preview" ? "hidden xl:block" : "block"}`}>
          ...
          <button
            ...
            className="xl:hidden flex items-center gap-2 text-sm text-muted-foreground mb-4 hover:text-foreground transition-colors bg-card/60 backdrop-blur-sm rounded-2xl p-4 border border-border/50 w-full"
          >
            <ArrowLeft className="w-4 h-4" />
            Back to Projects
          </button>
